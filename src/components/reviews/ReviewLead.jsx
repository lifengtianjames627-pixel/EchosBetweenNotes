...
export default function ReviewLead({ review, onOpen }) {
  ...
  return <button onClick={() => onOpen(review.album_id)} className="group relative min-h-[310px] overflow-hidden rounded-3xl text-left" style={{ border: '1px solid rgba(165,180,252,0.25)' }}>
    {review.album_cover_url ? <img src={review.album_cover_url} alt="" className="absolute inset-0 h-full w-full object-cover opacity-70 transition-transform duration-500 group-hover:scale-105" /> : <img src="https://media.base44.com/images/public/69bfbc84f5aa64ed245721b1/9e48e0666_generated_image.png" alt="" className="absolute inset-0 h-full w-full object-cover opacity-70" />}
