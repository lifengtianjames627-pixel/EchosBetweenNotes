...
export default function GenrePhotoHero({ genreId, label, tagline, description, v, featuredImage }) {
  const [defaultPhoto, note] = PHOTOS[genreId] || PHOTOS.electronic;
  const photo = featuredImage || defaultPhoto;
